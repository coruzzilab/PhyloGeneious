...
if [[ ! -f $OID_USER_DIR/data/familydone ]]; then
...
python $OID_BIN/fix_tree.py mpt.tre mpt_fixed.tre
python $OID_BIN/fix_tree.py mpt.nel mpt_nel_fixed.tre
python $OID_BIN/fix_tree.py jac.tre jac_fixed.tre
