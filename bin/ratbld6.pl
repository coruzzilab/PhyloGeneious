...
{    #mandatory parameters - should be in data subdirectory to run
    ...
    for ( my $k = $n + 1 ; $k > 1 ; $k-- ) {
        ...
        $buffer .= "macro-;\n";
        $buffer .= "col 3;\n";
        $buffer .= "pfijo: slack 100 numsels 1;\n";
        ...
        for ( my $j = $i ; $j > 0 ; $j-- ) { ############################### RAT
          ...
          #            }
            ...
            $buffer .=
              "quote ------------------ pinion (pfijo) SEARCH $j of $i;\n";
            $buffer .= "xi;\n";
            $buffer .= "riddup;\n";
            $buffer .= "pfijo 0;\n";
            $buffer .= "riddup-;\n";
    ...
    $buffer .= "set chk ntrees+20;\n";
    $buffer .= "hold  'chk';\n";
    $buffer .= "macro-;\n";
    $buffer .= "tf: rounds 1 min 7;\n";
    ...
    print(
        "USAGE: ratbld4.pl  [-h hold] [-i iterations] -m matrix.ss -n files\n\n"
    );
