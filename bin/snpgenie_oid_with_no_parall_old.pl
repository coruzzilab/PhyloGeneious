...
#							# PARALLELIZE IT
#							mkdir("$partition_id\_between_polymorphic_codons_arr");
#							chdir("$partition_id\_between_polymorphic_codons_arr");
...
#								#print "$codon_to_print";
#								my $this_codon_poly = 0;
#								OUTER: for (my $gi_spp_index = 0; $gi_spp_index < $num_seqs_per_codon_groupi; $gi_spp_index++) { # for each gi sequence at this codon
#
#									##my $codon_gi = $groups_codons_aa[$i]->[$codon_index]->[$gi_seq_index];
#									# Codon to compare against
#
#									INNER: for (my $gj_spp_index = 0; $gj_spp_index < $num_seqs_per_codon_groupj; $gj_spp_index++) { # for each gj sequence at this codon
#
...
#
#							chdir("..");
#							rmdir("$partition_id\_between_polymorphic_codons_arr");
